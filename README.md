...
of the response code, response type, body size and hash.

Then run a Delta-debugging loop on the request using something like [WDD](https://arxiv.org/abs/2411.19410)
to find the smallest subset of the request inputs where it still succeeds. Consider each of the cookies,
and some of other similar multi-value headers (such as Accept) as separate inputs.
